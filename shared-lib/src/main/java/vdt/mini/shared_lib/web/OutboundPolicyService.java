...
public class OutboundPolicyService {
    ...
    public OutboundExecutionPolicy resolve(OutBoundSecurity annotation) {
        ...
        EndpointRegistry.OutboundEndpoint endpoint = endpointRegistry
        ...
        validateSettings(endpoint, settings, protocol, method, annotation.targetUrl());
