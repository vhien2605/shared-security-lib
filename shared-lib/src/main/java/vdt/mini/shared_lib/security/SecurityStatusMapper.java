...
public class SecurityStatusMapper {
    public HttpStatus toHttpStatus(SecurityErrorCode errorCode) {
        ...
        return switch (errorCode) {
            ...
            case INVALID_TOPIC, CONFIG_ERROR, SERIALIZATION_ERROR -> HttpStatus.BAD_REQUEST;
            case AUTHORIZATION_ERROR -> HttpStatus.FORBIDDEN;
            case RECORD_TOO_LARGE -> HttpStatus.PAYLOAD_TOO_LARGE;
            case HTTP_5XX, HTTP_CLIENT_FAILED, RETRY_EXHAUSTED,
                    PUBLISH_FAILED, BROKER_UNAVAILABLE, PRODUCER_EXCEPTION, PUBLISH_INVOKED,
    ...
    public String mqResultCode(SecurityErrorCode errorCode) {
        ...
        return switch (errorCode) {
            ...
            case INVALID_TOPIC, CONFIG_ERROR, SERIALIZATION_ERROR -> "SEC-400";
            case AUTHORIZATION_ERROR -> "SEC-403";
            case RECORD_TOO_LARGE -> "SEC-413";
            case BROKER_UNAVAILABLE -> "SEC-560";
            case PUBLISH_FAILED, PRODUCER_EXCEPTION -> "SEC-562";
            case PUBLISH_INVOKED -> "SEC-202";
